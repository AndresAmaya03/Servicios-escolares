...
<div class="container pb-6 pt-6">
	...
	<?php 
		...
		$nombreUsuario = verificarPermisos($_SESSION['id']);
		
		if($nombreUsuario != "administrador"){
			include "./inc/btn_back.php";
			echo '
		            <div class="notification is-danger is-light">
		                <strong>¡No se puede agregar usuario!</strong><br>
		                No cuenta con los permisos para agregar usuarios
		            </div>
		        ';
		}else{
			//Si es el administrador, permitir agregar usuarios
			?>
